...
from chartlib import CanvasSpec, ColorPatchChart, GrayscaleStepChart, SiemensStarChart, SlantedEdgeChart
...
def test_region_annotations_share_common_bounds_fields() -> None:
    ...
    for region in (step_region, chart_region, edge_region, star_region, ray_region, patch_region):
